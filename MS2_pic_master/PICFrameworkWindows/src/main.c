   ...
   // OpenUSART(USART_TX_INT_OFF & USART_RX_INT_ON & USART_ASYNCH_MODE & USART_EIGHT_BIT &
    ...
    while (1) {
        ...
        if (length < 0) {
            ...
            switch (msgtype) {
                case MSGT_SEND_SENSOR_DATA_TO_ARM:
                {
                ...
                case MSGT_I2C_DBG:
                {
                    ...
                    char testbuffer1 = msgbuffer[1];
                    char testbuffer2 = msgbuffer[2];
                    char testbuffer3 = msgbuffer[3];
                    char testbuffer4  =msgbuffer[4];
                    char testbuffer5 = msgbuffer[5];
                    
                    
                    putIntoUARTBuffer(msgbuffer);
